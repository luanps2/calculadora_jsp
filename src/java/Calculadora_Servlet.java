 ...
 * @author Luan Costa
 */
@WebServlet(urlPatterns = {"/Calculadora_Servlet"})
public class Calculadora_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Calculadora_Servlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Calculadora_Servlet at " + Calcular(v1, v2, op) + "</h1>");
            out.println("</body>");
            out.println("</html>");
